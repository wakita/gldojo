...
- `pacman -Su msys/pkg-config`
- `pacman -Su msys/automake-wrapper`
- `pacman -Su msys/git`
- `pacman -Su mingw64/mingw-w64-x86_64-make`
- `pacman -Su mingw64/mingw-w64-x86_64-cmake`
- `pacman -Su mingw64/mingw-w64-x86_64-gcc`
- `pacman -Su mingw64/mingw-w64-x86_64-glfw`
- `pacman -Su mingw64/mingw-w64-x86_64-nodejs`
- `pacman -Su mingw64/mingw-w64-x86_64-jsoncpp`
